...
// GET /api/startups
// Fetch ALL startups
// Optional query filters: state, sector, minFunding
// ----------------------------
router.get("/", async (req, res) => {
  try {
    ...
    if (req.query.state) {
      query.state = sanitizeString(req.query.state, 80);
    }

    if (req.query.sector) {
      query.sector = sanitizeString(req.query.sector, 120);
    }
...
// ----------------------------
// GET /api/startups/:id
// Fetch ONE startup by ID
// (Required for details page)
// ----------------------------
